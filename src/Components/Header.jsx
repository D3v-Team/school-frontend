...
const NAV = [
    {
        key: 'umumiy', label: "Umumiy ma'lumot",
        items: [
            ...
            { to: '/ramzlar',             label: 'Davlat ramzlari' },
        ],
    },
    {
        key: 'talim', label: "Ta'lim",
        items: [
    ...
    {
        key: 'axborot', label: 'Axborot xizmati',
        items: [
    ...
    { key: 'boglanish', label: "Bog'lanish", to: '/contact' },
];
                        ...
                        <div className="h-service flex items-center gap-5">
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-semibold text-slate-200">+998 (95) 511 58 56</p>
                                </div>
                            </div>
                            {/* email */}
                            <div className="flex items-center gap-2.5">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-semibold text-slate-200">info@maktab.uz</p>
                                </div>
                            </div>
                            {/* address */}
                            <NavLink to="/contact"
