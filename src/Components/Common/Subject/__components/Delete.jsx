...
import { useDeleteSubjectMutation } from "../../../../store/services/subject.api";
import { Trash, AlertTriangle } from "lucide-react";
import { Alert } from "../../../Other/UI/Alert/Alert";

export default function Delete({ subject }) {
    ...
    const handleDelete = async () => {
        try {
            ...
            Alert(`Fan "${subject.name}" o‘chirildi`, "success");
            handleClose();
        } catch (error) {
        ...
        <>
            ...
            >
                ...
                <DialogBody className="text-text-secondary">
                    <p className="mb-2">
                        Siz <span className="font-semibold text-text-primary">{subject.name}</span> fanini o‘chirmoqchisiz.
                    </p>
