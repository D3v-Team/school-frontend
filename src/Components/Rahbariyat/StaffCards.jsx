            ...
            <div>
              ...
              <div className="staff_soci text-gray-700 space-y-4 mt-[30px]">
                <p className="flex items-center gap-[10px]">
                  ...
                  <span className="font-medium">{t('Qabulkunlari')}:</span> {person?.reception_days}
                </p>
                <p className="flex items-center gap-[10px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <span className="font-medium">{t('Telefon')}:</span> {person?.phone}
                </p>
                <p className="flex items-center gap-[10px]">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <span className="font-medium">{t('Email')}:</span> {person?.email}
                </p>
              </div>
            </div>
