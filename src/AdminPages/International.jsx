...
export default function AdminInternational() {
    ...
    return (
        <div>
            <h2 className="text-xl font-bold mb-4">Xalqaro aloqalar</h2>
            <div className="flex justify-between items-center">
                ...
                <div>
                    <NavLink className="block" to="/admin/international/create">
                    ...
                    <div key={index} className="bg-white p-5 rounded-lg mt-5 shadow">
                        <div className="flex items-center justify-end">
                            <div className="flex items-center gap-2">
                                <NavLink to={`/admin/international/edit/${i?.id}`}>
                                    <IconButton className="bg-blue-500 text-white" variant="text">
                                        <FaPencilAlt className="h-4 w-4" />
                                    </IconButton>
                                </NavLink>
                                <InternationalDelete Id={i?.id} refresh={fetchData} />
                            </div>
                        </div>
